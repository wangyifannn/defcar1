function loadDriverList() {
    $("#DriverTable").bootstrapTable('destroy').bootstrapTable({
        ...
        url: 'https://wangyifannn.git/hub.io/newdefcar/json/driverList.json',
        // url: 'http://192.168.0.222:8080/car-management/driver/CarDriverList.action',
        // dataType: "json", //数据类型
        // method: 'GET', //请求方式（*）
        dataType: 'json',
        // ajaxOptions: {
...
window.driveroperateEvents = {
    ...
    'click #btn_driverup': function(e, value, row, index) { //修改
        ...
        $(".editDriver_btn").click(function() {
            ...
            subData(sub_url, sub_data, "post", "editDriver_btn");
        })
    },
...
$("#driver_add_btn").click(function() {
    ...
    $(".subdriver_btn").click(function() {
        ...
        $(this).attr({ "data-dismiss": "modal", "aria-label": "Close" });
        subData(sub_url, sub_data, "post", "subDriver_btn");
    })
});
...
var addDrverInfo = [
    ...
    { "name": "iccard", "type": "text", "inputName": "iccard", "must": "" },
    {
        ...
        "inputName": "gids",
        "must": "",
        "option": [{ "name": "A组", "id": 1, "remark": "s" }, { "name": "B组" }, { "name": "C组" }]
    },
    {
        "name": "是否授权",
        "type": "radio",
