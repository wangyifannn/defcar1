...
function caroperateFormatter(value, row, index) {
    var carbtns = '<li><a href="#carTypeIn" data-toggle="tab"><button type="button" id="carTypeIn_btn" class="my_btn btn btn-default btn-sm" style="margin-right:15px;">录入</button></a></li>' +
        ...
        '<li><a href="#"><button type="button" id="rd_btn" class="my_btn btn btn-default btn-sm" style="margin-right:15px;">研发</button></a></li>' +
        ...
        '<li><a href="#"><button type="button" id="audit_btn" class="my_btn btn btn-default  btn-sm" style="margin-right:15px;">审核</button></a></li>';
